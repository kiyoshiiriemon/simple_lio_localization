...
public:
    ...
    bool match(const std::vector<PointCloudPCL>& pc_vec, const std::vector<Pose3d>& lio_pose_vec, const Pose3d& pose_guess, Pose3d& out_map_pose, PointCloudPCL& registered_cloud);
private:
    Map map_;
